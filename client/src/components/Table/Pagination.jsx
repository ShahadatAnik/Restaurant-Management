		...
		<div className="mb-4 mt-4 flex select-none flex-col items-end justify-around gap-2 md:flex-row md:items-center">
			<div className="flex items-end gap-6 text-sm  md:items-center">
				<span className="flex items-center gap-1 text-sm">
					<select
						className="max-w-x select select-accent select-sm"
						value={pageSize}
						onChange={(e) => {
				...
				<span className="flex items-center gap-1 text-sm">
					...
					<input
						type="text"
						className="input input-accent input-sm max-w-[4rem] text-center"
				...
				{/* <div className="flex items-center gap-[0.15rem] text-sm"></div> */}
			</div>
